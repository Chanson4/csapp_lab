...
00000000004010f4 <phase_6>:
  ...
  401121:	76 05                	jbe    401128 <phase_6+0x34> # eax <= 5 跳转 否则explode
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d # r12 += 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d 
  401130:	74 21                	je     401153 <phase_6+0x5f> # r12 == 6 跳转
  401132:	44 89 e3             	mov    %r12d,%ebx # ebx = r12
  401135:	48 63 c3             	movslq %ebx,%rax # rax = ebx 
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # eax = (rsp + 4rax)
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> # (rbp) != eax
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx # ebx += 1
  401148:	83 fb 05             	cmp    $0x5,%ebx 
  40114b:	7e e8                	jle    401135 <phase_6+0x41> # ebx <= 5 回跳
  40114d:	49 83 c5 04          	add    $0x4,%r13 # r13 += 4
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # 回跳
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # rax != rsi 回跳
  ...
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # eax != ecx 回跳
  401181:	eb 05                	jmp    401188 <phase_6+0x94> # 跳转
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx # edx = xxx
  ...
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # ecx <= 1 回跳 
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax # eax = 1
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx # edx = xxx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> # 回跳
  ...
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> # rax == rsi 跳转
  4011cd:	48 89 d1             	mov    %rdx,%rcx # rcx = rdx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9> # 回跳
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> # (rbx) >= eax
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx # rbx = (rbx + 8)
  4011f2:	83 ed 01             	sub    $0x1,%ebp # ebp -= 1
  4011f5:	75 e8                	jne    4011df <phase_6+0xeb> # ebp != 0 回跳
